...
#include <ipharobotv4_msgs/SensorState.h>
#include <ipharobotv4_msgs/VersionInfo.h>
#include <string>
...
void sensorStateMsgCallback(const ipharobotv4_msgs::SensorState::ConstPtr &msg)
{
  if (msg->battery > 11.0)
  ...
  if (msg->button == ipharobotv4_msgs::SensorState::BUTTON0)
    setButtonDiagnosis(diagnostic_msgs::DiagnosticStatus::OK, "BUTTON 0 IS PUSHED");
  else if (msg->button == ipharobotv4_msgs::SensorState::BUTTON1)
...
void firmwareVersionMsgCallback(const ipharobotv4_msgs::VersionInfo::ConstPtr &msg)
{
  ...
  ipharobotv4_msgs::VersionInfo version;
...
int main(int argc, char **argv)
{
  ...
  tb3_version_info_pub = nh.advertise<ipharobotv4_msgs::VersionInfo>("version_info", 10);
